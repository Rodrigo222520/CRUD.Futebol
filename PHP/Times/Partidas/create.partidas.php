...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($time_casa_id == $time_fora_id) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $erro = "Erro ao criar partida: " . mysqli_error($conn);
        }
    }
}
?>
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                <label>Placar:</label>
                <div class="placar">
                    <input type="number" name="gols_casa" required min="0" max="20" value="0">
                    <span>X</span>
                    <input type="number" name="gols_fora" required min="0" max="20" value="0">
                </div>
            </div>
            
            <div class="form-actions">
                <button type="submit" class="btn">✅ Salvar Partida</button>
